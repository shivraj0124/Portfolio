        ...
        <div className='w-[100%] flex flex-col justify-start items-start'>
            ...
            <h1 className='font-bold text-3xl'>I Am Shivraj Santosh Kolwankar</h1>
                  ...
                  <div className='text-sm mt-5 flex flex-row gap-4 '>
                    <button className='py-1 px-3 hover:bg-cyan-500 hover:text-white border-2 border-cyan-500 text-cyan-600 font-semibold rounded-md'>See Projects</button>
                    <button className='py-1 px-3 hover:bg-cyan-500 hover:text-white border-2 border-cyan-500 text-cyan-600 font-semibold rounded-md'>Send Email</button>
                  </div>
        </div>
        <div className='w-[100%]'>
