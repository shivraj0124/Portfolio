...
function Footer() {
  return (
      ...
      <h1 className='text-2xl font-bold text-center flex flex-row justify-center items-center gap-x-2'><IoIosHeartEmpty className="text-red-600" /> SHIVRAJ SANTOSH KOLWANKAR  <IoIosHeartEmpty className="text-red-600" /></h1>
